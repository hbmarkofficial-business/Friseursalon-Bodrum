  ...
  return (
    <>
      <Helmet>
        ...
        <title>Friseursalon Mönchengladbach | Friseursalon Bodrum</title>
        <meta
          name="description"
          content="Besuche unseren Premium Friseursalon Friseursalon Bodrum in Mönchengladbach für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Friseursalon Bodrum | Premium Friseursalon Mönchengladbach" />
        <meta
        ...
        <meta name="twitter:title" content="Friseursalon Bodrum | Premium Friseursalon Mönchengladbach" />
        <meta
